...
print(harvest('zucchini', 600))
print(harvest('zucchini', 239))
print(harvest('zucchini', 1595))
print(harvest('zucchini', 1518))
print(harvest('zucchini', 1320))
print(harvest('zucchini', 1049))
print(harvest('chili pepper', 7))
print(harvest('zucchini', 380))
print(harvest('zucchini', 429))
print(harvest('zucchini', 277))
print(harvest('Radu squash', 833))
print(harvest('zucchini', 1016))
print(harvest('chili pepper', 6))
print(harvest('zucchini', 515))
